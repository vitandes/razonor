...
// El semestral se cobra cada 6 meses con ~33% de descuento frente a pagar
// mes a mes ($119.900 vs $179.400 en el individual).
const PLAN_DETAILS = {
  individual: {
    label: "Individual",
    monthly: { amount: 29900, frequency: 1 },
    semestral: { amount: 119900, frequency: 6 },
  },
  // Legado: se conserva para webhooks/renovaciones ya existentes. Los
  // endpoints de checkout no aceptan nuevas compras familiares.
  familiar: {
    label: "Familiar",
