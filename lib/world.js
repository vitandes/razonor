...
// Cada mecánica entrena una habilidad. "ia" = evaluar si una IA acierta.
// Nota: `error` (detectar el error) y `comprension` (leer y entender un texto)
// entrenan ambas la habilidad de comprensión de lectura.
...
export const CHAPTERS = [
  ...
  },
  {
    ...
    locked: false,
    intro:
      "El museo estrenó a Razobot, un robot con inteligencia artificial que ayuda a resolver casos. Pero Razobot a veces se equivoca o inventa cosas con mucha seguridad. Tu misión: pensar por ti mismo y no creerle todo.",
    cases: [
      {
        id: "c2-nocreas",
        ...
        brief:
          "Razobot te va a dar pistas para encontrar al ladrón. Algunas son buenas… y otras son puros inventos. Tú decides a cuáles hacerles caso.",
        retos: [
          {
            id: "c2n-r1",
            mechanic: "ia",
          ...
          },
          {
            ...
            explicacion:
              "La hora 25:00 no existe, así que Razobot está equivocado aunque suene seguro. Verificar te muestra que la respuesta con sentido es la de Lumi. Las IA sí ayudan, pero hay que revisarlas.",
          },
        ],
      },
      {
        ...
        focus: ["Lógica", "Problemas", "Razonamiento espacial"],
        brief:
          "Razobot va a sacar conclusiones muy rápido. Algunas suenan lógicas pero están mal. Usa tu cabeza para no caer.",
        retos: [
          {
            id: "c2p-r1",
            mechanic: "ia",
            ...
            explicacion:
              "Razobot sacó una conclusión apurada. Una sola coincidencia no prueba nada: para acusar a alguien hacen falta más pistas. Pensar despacio le gana a la máquina apurada.",
          },
          {
            id: "c2p-r2",
          ...
          },
          {
            id: "c2p-r3",
            mechanic: "espacial",
            prompt: "La flecha de la caja gira un cuarto de vuelta a la derecha cada vez.",
            clues: ["↑  →  ↓  ❓"],
            question: "¿Cómo debe quedar la siguiente flecha?",
            options: ["←", "↑", "→"],
            answer: "←",
            hint: "Sigue el giro: arriba, derecha, abajo…",
            explicacion: "Después de apuntar hacia abajo, otro cuarto de vuelta a la derecha apunta hacia la izquierda ←.",
          },
          {
            id: "c2p-r4",
            mechanic: "ia",
