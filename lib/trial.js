...
export const CTA_START = "Empezar";
export const CTA_START_LONG = "Saber por dónde empezar";
export const CTA_PROBLEM = "Descubrir qué necesita reforzar";
export const CTA_PLAN = HAS_TRIAL ? `Empezar prueba de ${TRIAL_LABEL}` : "Elegir este plan";
