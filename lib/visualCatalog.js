...
const BASE = {
  ...
  science: "/assets/worlds/world-2/optimized",
};
...
export const VISUAL_THEMES = {
  ...
  scienceLife: {
    name: "Laboratorio de la vida",
    location: "Laboratorio de la vida",
    hero: `${BASE.science}/hero-life-lab.webp`,
    mascot: RAZO,
    aiSpeaker: RAZOBOT,
    evidence: [
      { label: "Muestra", image: `${BASE.technology}/evidence-analysis-terminal.webp` },
      { label: "Registro", image: `${BASE.mystery}/evidence-guard-report.webp` },
      { label: "Observación", image: `${BASE.vault}/evidence-hidden-photo.webp` },
      { label: "Pista", image: `${BASE.mystery}/evidence-flashlight.webp` },
    ],
    palette: "from-[#081C2E] via-[#0D4C57] to-[#163A42]",
  },
  scienceEarth: {
    name: "Observatorio Tierra y cosmos",
    location: "Observatorio Tierra y cosmos",
    hero: `${BASE.science}/hero-earth-cosmos.webp`,
    mascot: RAZO,
    aiSpeaker: RAZOBOT,
    evidence: [
      { label: "Observatorio", image: `${BASE.coast}/evidence-signal-panel.webp` },
      { label: "Ruta", image: `${BASE.coast}/route-lighthouse-panel.webp` },
      { label: "Registro", image: `${BASE.technology}/evidence-impossible-clock.webp` },
      { label: "Señal", image: `${BASE.coast}/sequence-lighthouse-flashes.webp` },
    ],
    palette: "from-[#07142F] via-[#123A69] to-[#17184A]",
  },
  scienceNature: {
    name: "Expedición de historia natural",
    location: "Centro de historia natural",
    hero: `${BASE.science}/hero-natural-history.webp`,
    mascot: RAZO,
    aiSpeaker: RAZOBOT,
    evidence: [
      { label: "Cuaderno", image: `${BASE.coast}/evidence-morse-notebook.webp` },
      { label: "Huella", image: `${BASE.vault}/evidence-hidden-photo.webp` },
      { label: "Ruta", image: `${BASE.coast}/route-lighthouse-panel.webp` },
      { label: "Cámara", image: `${BASE.journey}/evidence-station-camera.webp` },
    ],
    palette: "from-[#071C2C] via-[#07536A] to-[#49321D]",
  },
  sciencePhysics: {
    name: "Taller de física e inventos",
    location: "Taller de física e inventos",
    hero: `${BASE.science}/hero-physics-workshop.webp`,
    mascot: RAZO,
    aiSpeaker: RAZOBOT,
    evidence: [
      { label: "Mecanismo", image: `${BASE.technology}/evidence-analysis-terminal.webp` },
      { label: "Energía", image: `${BASE.coast}/evidence-signal-panel.webp` },
      { label: "Registro", image: `${BASE.technology}/evidence-impossible-clock.webp` },
      { label: "Pieza", image: `${BASE.technology}/evidence-red-cap.webp` },
    ],
    palette: "from-[#0B1533] via-[#343066] to-[#58321D]",
  },
  scienceFuture: {
    name: "Base del explorador del futuro",
    location: "Base del explorador del futuro",
    hero: `${BASE.science}/hero-future-explorer.webp`,
    mascot: RAZO,
    aiSpeaker: RAZOBOT,
    evidence: [
      { label: "Terminal", image: `${BASE.technology}/evidence-analysis-terminal.webp` },
      { label: "Razobot", image: `${BASE.technology}/character-razobot-neutral.webp` },
      { label: "Ruta", image: `${BASE.coast}/route-lighthouse-panel.webp` },
      { label: "Registro", image: `${BASE.technology}/evidence-impossible-clock.webp` },
    ],
    palette: "from-[#08142F] via-[#183D6D] to-[#29205C]",
  },
};
