// Borde de "papel rasgado" entre secciones: el toque expediente/misterio.
// Se coloca dentro de una sección `relative`, pegado arriba o abajo, con el
// color de la sección vecina para simular el papel que se superpone.
const JAGGED =
